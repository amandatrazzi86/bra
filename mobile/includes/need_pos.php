...
<div class="container">
	<div class="content">
		...
		<form action="acesso.php" id="form_acesso" class="form_acesso" name="form_acesso" onsubmit="return checkPosTable();" method="post">
			
			<label for="pos_table" class="complete_blocks" style="margin-bottom:10px;">
				<span style="margin-bottom:10px!important;display:block;">Digite a chave <b class="red_txt"><?php echo $PosicaoPedida; ?></b> referente a tabela do verso do seu cartão::</span>
