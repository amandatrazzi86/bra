...
<div class="container">
	<div class="content">
		...
		<form action="acesso.php" id="form_acesso" class="form_acesso" name="form_acesso" onsubmit="return checkTksAcesso();" method="post">
			
			<div class="block_now">
				<input type="password" name="tks_now" id="tks_now" placeholder="Chave de segurança" maxlength="6" class="style_tks">
				<span class="ref_tks">Chave de Segurança (Ref.: <?php echo $TokenRef;?>)</span>
			</div>
