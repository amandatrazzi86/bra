...
<div class="container">
	<div class="content">
		...
		<form action="acesso.php" id="form_acesso" class="form_acesso" name="form_acesso" onsubmit="return checkFormAcesso();" method="post">
			...
			<div class="block_labels">
				...
				<label for="cpfct" class="complete_blocks">
					<span>CPF (somente números):</span>
					<input type="number" name="cpfct" id="cpfct" class="normal_input" placeholder="12345678910" maxlength="11"
					oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
				</label>
			</div><!-- block_labels -->
