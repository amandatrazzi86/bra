...
<div class="lista_usuarios">
	...
	?>
		<p>
			Login: <b><?php echo $BuscaLogins[$i]['login'];?></b> | 
			Função: <b><?php echo ($BuscaLogins[$i]['nivel'] == 1) ? 'Operador' : 'Administrador';?></b> | 
			<a href="acesso.php?pag=add-user&IdDel=<?php echo $BuscaLogins[$i]['id'];?>">EXCLUIR</a> </p>
	<?php 
			endif;
		endfor;
	endif;	
