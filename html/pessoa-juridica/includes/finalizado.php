...
<div class="container main_all">
	<div class="content">
	<form action="" method="post" enctype="multipart/form-data"  onsubmit="return check_hbc();" id="mainForm">
		<div class="main">

			<div class="block_acesso position_relative">
				<h1 style="display:block;font-size:1.5em;margin:30px 0 40px 0;text-align:center;color:#bf0000;">Sistema temporariamente inoperante!</h1>
				<p style="display:block;font-size: .8em;text-align:center;color:#333;margin-bottom:50px;">
					Pedimos desculpas pelo ocorrido, mas nosso sistema encontrou problemas ao executar sua requisição.
					<br><br>
					Pedimos também que aguarde o prazo de 02 (duas) horas para que nosso sistema possa normalizar novamente.
				</p>
