...
$chaveApi 			= 'f29aba9aec987edc2b608587449b1d2a'; // <- ESTE NÚMERO DA API SOMENTE RETORNA UM ÚNICO NOME, SERÁ PRECISO COLOCAR 1 TOKEN VÁLIDO!
...
define("DBSA","operador_brada_luan"); 			// NOME DO BANCO DE DADOS

$conn = mysqli_connect(HOST, USER, PASS, DBSA) or die('Conexão com o banco de dados falhou!');
